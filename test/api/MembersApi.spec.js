...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new hullojs.MembersApi();
  });
  ...
  describe('MembersApi', function() {
    ...
    describe('optOutMember', function() {
      it('should call optOutMember successfully', function(done) {
        //uncomment below and update the code to test optOutMember
        //instance.optOutMember(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('upsertMember', function() {
      it('should call upsertMember successfully', function(done) {
        //uncomment below and update the code to test upsertMember
        //instance.upsertMember(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
