...
(function(root, factory) {
  ...
  describe('AttributeEditType', function() {
    it('should create an instance of AttributeEditType', function() {
      // uncomment below and update the code to test AttributeEditType
      //var instance = new hullojs.AttributeEditType();
      //expect(instance).to.be.a(hullojs.AttributeEditType);
    });
